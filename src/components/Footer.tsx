...
const navigation = {
  services: [
    { name: 'Press Release Writing', href: '/services#writing' },
    { name: 'Media Distribution', href: '/services#distribution' },
    { name: 'Crisis Management', href: '/services#crisis' },
    { name: 'Media Monitoring', href: '/services#monitoring' },
  ],
  company: [
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/prservices',
      icon: (props: any) => (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/prservices',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'Facebook',
      href: 'https://facebook.com/prservices',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-300">
                  Get the latest PR insights and industry news delivered to your inbox.
                </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} PR Services. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
